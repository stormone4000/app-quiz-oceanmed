...
export function ProfessorDashboard({ results, onLogout, hostEmail, needsSubscription }: ProfessorDashboardProps) {
  const [activeTab, setActiveTab] = useState<'stats' | 'quizzes' | 'student-quiz' | 'access-codes' | 'profile' | 'videos' | 'quiz-studenti' | 'notifications' | 'subscriptions' | 'students' | 'quiz-live' | 'dashboard' | 'gestione-quiz' | 'gestione-alunni'>('dashboard');
