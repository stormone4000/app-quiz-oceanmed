/*
  ...
  1. Changes
    ...
    - Update instructor verification to handle master admin
    - Add single master admin constraint
...
-- Add master admin flag to auth_users if not exists
...
-- Drop and recreate instructor verification with updated signature
