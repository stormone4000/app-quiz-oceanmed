...
-- Create interactive quiz templates table
...
-- Create interactive quiz questions table
...
-- Create policies for interactive_quiz_templates
CREATE POLICY "Public can view interactive quiz templates"
  ON interactive_quiz_templates FOR SELECT
  TO public
  USING (true);

CREATE POLICY "Public can create interactive quiz templates"
  ON interactive_quiz_templates FOR INSERT
  TO public
  WITH CHECK (true);

CREATE POLICY "Public can update interactive quiz templates"
  ON interactive_quiz_templates FOR UPDATE
  TO public
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Public can delete interactive quiz templates"
  ON interactive_quiz_templates FOR DELETE
  TO public
  USING (true);

-- Create policies for interactive_quiz_questions
...
-- Create policies for live_quiz_sessions
...
-- Create policies for live_quiz_participants
...
INSERT INTO interactive_quiz_templates (
  ...
  'Quiz di Prova',
  'Un quiz di prova per testare il sistema',
  'public',
  'multiple_choice',
  5,
  10,
